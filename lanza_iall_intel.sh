...
#        mpirun -np $i -ppn 1 -genv I_MPI_ADJUST_IALLREDUCE 4 -iface ib0 -f myhostfile.$$  ./${exe} 1 1 0 > ${dir2}/iallreduce_auto_${i}.dat
        ...
        do
            unset I_MPI_ADJUST_IALLREDUCE
            mpirun -np $i -ppn 1 -iface ib0 -f myhostfile.$$  ./${exe} 1 $p 0 > ${dir2}/iallreduce_${i}_procs_${p}_parts.dat
            mpirun -np $i -ppn 1 -genv I_MPI_ADJUST_IALLREDUCE 4 -iface ib0 -f myhostfile.$$  ./${exe} 1 $p 0 > ${dir2}/iallreduce_best_${i}_procs_${p}_parts.dat
        done
done
