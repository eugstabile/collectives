...
do
    ...
    for p in ${part}
    do
         mpirun -np $i --map-by node -mca btl openib --mca btl_openib_allow_ib true --oversubscribe --mca coll libnbc,basic --mca coll_libnbc_iallreduce_algorithm 1  --hostfile myhostfile.$$ --mca  mpi_warn_on_fork 0 ./${exe} 1 $p 0 1048576 > ${dir}/iallreduce_${p}.dat
