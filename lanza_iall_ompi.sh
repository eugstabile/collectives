...
do
    ...
    do 
        ...
        do
            ...
            --mca coll_libnbc_priority 40 --hostfile myhostfile.$$ --mca  mpi_warn_on_fork 0 ./${exe} 0 1 $p > ${dir}/iallreduce_${a}_alg_procs_${i}_parts_${p}.dat
    #done
